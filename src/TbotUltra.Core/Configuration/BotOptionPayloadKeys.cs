...
public static class BotOptionPayloadKeys
{
    ...
    public const string ContinuousFarmDeactivateRedLosses = "continuous_farm_deactivate_red_losses";
    public const string ContinuousFarmDeactivateYellowLosses = "continuous_farm_deactivate_yellow_losses";
    public const string ContinuousFarmDeactivateRedOasisLosses = "continuous_farm_deactivate_red_oasis_losses";
    public const string ContinuousFarmDeactivateYellowOasisLosses = "continuous_farm_deactivate_yellow_oasis_losses";
    public const string ContinuousFarmMoveRedLosses = "continuous_farm_move_red_losses";
    public const string ContinuousFarmMoveYellowLosses = "continuous_farm_move_yellow_losses";
    public const string ContinuousFarmRedLossDestinationListId = "continuous_farm_red_loss_destination_list_id";
    public const string ContinuousFarmRedLossDestinationListName = "continuous_farm_red_loss_destination_list_name";
    public const string ContinuousFarmRedLossDestinationBaseName = "continuous_farm_red_loss_destination_base_name";
    public const string ContinuousFarmYellowLossDestinationListId = "continuous_farm_yellow_loss_destination_list_id";
    public const string ContinuousFarmYellowLossDestinationListName = "continuous_farm_yellow_loss_destination_list_name";
    public const string ContinuousFarmYellowLossDestinationBaseName = "continuous_farm_yellow_loss_destination_base_name";
    ...
    public const string PostLoginAnalyzeNewAccount = "post_login_analyze_new_account";
