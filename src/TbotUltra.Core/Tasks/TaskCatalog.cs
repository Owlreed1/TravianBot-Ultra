...
public static class TaskCatalog
{
    ...
    [
        new("status", TaskGroup.Account, "Status", false, TaskPayloadKind.None),
        new("scan_all_villages", TaskGroup.Account, "Scan all villages", false, TaskPayloadKind.None),
        new("account_snapshot", TaskGroup.Account, "Account snapshot", false, TaskPayloadKind.None),
        ...
        new("anti_starve_hero_crop", TaskGroup.Account, "Anti-starve hero crop", true, TaskPayloadKind.None),
        ...
        new("collect_tasks", TaskGroup.Account, "Collect tasks", true, TaskPayloadKind.None),
        new("collect_daily_quests", TaskGroup.Account, "Collect daily quests", true, TaskPayloadKind.None),
        new("activate_production_bonus", TaskGroup.Account, "Activate 15% production", true, TaskPayloadKind.None),
        new("read_daily_reset", TaskGroup.Account, "Read daily server reset time", true, TaskPayloadKind.None),
    ];
