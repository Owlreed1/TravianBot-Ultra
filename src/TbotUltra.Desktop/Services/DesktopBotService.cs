...
public Task ExecuteLoginAsync(BotOptions options, Action<string> log, bool keepBrowserOpenAfterLogin, CancellationToken cancellationToken)
    ...
    public Task<VillageStatus> ReadCurrentBuildingOverviewStatusAsync(BotOptions options, Action<string> log, CancellationToken cancellationToken)
    {
    ...
    public Task<int?> ReadHeroHpFromCurrentPageAsync(BotOptions options, Action<string> log, CancellationToken cancellationToken)
    {
        return _taskRunner.ReadHeroHpFromCurrentPageAsync(options, log, null, cancellationToken);
    }
    ...
    public Task OpenTravcoAndSearchAsync(BotOptions options, TravcoSearchRequest request, Action<string> log, IProgress<TravcoSearchProgress>? progress, CancellationToken cancellationToken)
    {
        return _taskRunner.OpenTravcoAndSearchAsync(options, request, log, progress, cancellationToken);
    }
